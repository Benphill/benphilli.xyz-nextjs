...
export function TimelineItem({ img, text, subtext }: { img: string; text: string; subtext: string }) {
    return(
        <div className="flex mt-10">
            <Image src={img} width={300} height={200} alt="timeline item image" className="contain hover:animate-[scale_0.1s_forwards]" />
            <div className="bg-[#111111] max-w-120">
        ...
        <div className="size-full overflow-clip">
            <div className="h-215 w-[80%] mr-auto ml-auto bg-black font-serif overflow-clip">
                ...
                <div className="ml-10 overflow-auto max-h-107">
                    ...
                    <TimelineItem img={imagerotator(["/lotr/boromir.jpg", "/lotr/boromir2.jpg"])} text="Quote 1" subtext="subtext"/>
                    <TimelineItem img={imagerotator(["/lotr/gollum.jpg", "/lotr/gollum2.jpeg", "/lotr/gollum3.jpg"])} text="Still, he&apos;s a Baggins, my precious, yes, a Baggins. A  Baggins stole it. [..] We hates Bagginses. [...] All peoples that keep the Precious. We must have it!" subtext="- Gollum talking to Smeagol about Frodo"/>
                    <TimelineItem img={imagerotator(["/lotr/saruman.jpg", "/lotr/saruman2.jpg"])} text="Quote 3" subtext="subtext"/>
                 </div>
