      ...
      <div className="w-[100%] text-pink-950 font-mono">
        ...
        <div className="h-165 basis-1/1 lg:flex items-start pb-5 min-w-0 max-w-[100%]">          
          <div className="basis-3/10 mt-3">
            <div className="bg-maincol mt-1 p-2 border-1 rounded-lg ">
          ...
          <div className="bg-maincol basis-7/10 max-w-5xl lg:ml-3 mt-4 border-1 rounded-lg border-black h-135 min-w-0 overflow-x-hidden overflow-y-auto">
